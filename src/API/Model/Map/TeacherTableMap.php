...
use API\Model\Teacher;
use API\Model\TeacherQuery;
...
class TeacherTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'API.Model.Map.TeacherTableMap';
     ...
     */
    const OM_CLASS = '\\API\\Model\\Teacher';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'API.Model.Teacher';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Name', 'Email', ),
        self::TYPE_CAMELNAME     => array('id', 'name', 'email', ),
        self::TYPE_COLNAME       => array(TeacherTableMap::COL_ID, TeacherTableMap::COL_NAME, TeacherTableMap::COL_EMAIL, ),
        self::TYPE_FIELDNAME     => array('id', 'name', 'email', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Name' => 1, 'Email' => 2, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'name' => 1, 'email' => 2, ),
        self::TYPE_COLNAME       => array(TeacherTableMap::COL_ID => 0, TeacherTableMap::COL_NAME => 1, TeacherTableMap::COL_EMAIL => 2, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'name' => 1, 'email' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\API\\Model\\Teacher');
    ...
    {
        $this->addRelation('Assignment', '\\API\\Model\\Assignment', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':teacher_id',
    1 => ':id',
  ),
), null, null, 'Assignments', false);
    } // buildRelations()
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \API\Model\Teacher) { // it's a model object
