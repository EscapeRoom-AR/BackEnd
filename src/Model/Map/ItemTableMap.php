...
class ItemTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Model.Map.ItemTableMap';
     ...
     */
    const OM_CLASS = '\\Model\\Item';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Model.Item';
  ...
  array (
    ...
    1 => ':code',
        ...
        $this->addRelation('Hint', '\\Model\\Hint', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':item_code',
    1 => ':code',
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Model\Item) { // it's a model object
