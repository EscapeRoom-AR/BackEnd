...
class TeacherTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Model.Map.TeacherTableMap';
     ...
     */
    const OM_CLASS = '\\Model\\Teacher';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Model.Teacher';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Model\\Teacher');
    ...
    {
        $this->addRelation('Assignment', '\\Model\\Assignment', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':teacher_id',
    1 => ':id',
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Model\Teacher) { // it's a model object
