...
class RoomTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Model.Map.RoomTableMap';
     ...
     */
    const OM_CLASS = '\\Model\\Room';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Model.Room';
  ...
  array (
    ...
    1 => ':code',
        ...
        $this->addRelation('Item', '\\Model\\Item', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':room_code',
    1 => ':code',
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Model\Room) { // it's a model object
