...
class AssignmentTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Model.Map.AssignmentTableMap';
     ...
     */
    const OM_CLASS = '\\Model\\Assignment';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Model.Assignment';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Model\\Assignment');
    ...
    {
        $this->addRelation('Teacher', '\\Model\\Teacher', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':teacher_id',
    1 => ':id',
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Model\Assignment) { // it's a model object
