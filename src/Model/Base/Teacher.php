...
abstract class Teacher implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Model\\Map\\TeacherTableMap';
    ...
    /**
     * Initializes internal state of Model\Base\Teacher object.
     */
     ...
     * @return $this|\Model\Teacher The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Model\\Teacher'), 0, $e);
        }
    }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Model\Teacher The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Model\Teacher (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Model\Teacher Clone of current object.
     * @throws PropelException
     */
    ...
    public function initAssignments($overrideExisting = true)
    {
        ...
        $this->collAssignments->setModel('\Model\Assignment');
    }
