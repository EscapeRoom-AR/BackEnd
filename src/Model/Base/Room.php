...
use Model\Room as ChildRoom;
use Model\RoomQuery as ChildRoomQuery;
use Model\Map\GameTableMap;
use Model\Map\ItemTableMap;
use Model\Map\RoomTableMap;
...
abstract class Room implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Model\\Map\\RoomTableMap';
    ...
    /**
     * Initializes internal state of Model\Base\Room object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\Model\Room The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Model\\Room'), 0, $e);
        }
    }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Model\Room The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Model\Room (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Model\Room Clone of current object.
     * @throws PropelException
     */
    ...
    public function initItems($overrideExisting = true)
    {
        ...
        $this->collItems->setModel('\Model\Item');
    }
