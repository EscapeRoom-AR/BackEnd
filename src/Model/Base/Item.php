...
abstract class Item implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Model\\Map\\ItemTableMap';
    ...
    /**
     * Initializes internal state of Model\Base\Item object.
     */
     ...
     * @return $this|\Model\Item The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Model\\Item'), 0, $e);
        }
    }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Model\Item The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Model\Item (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Model\Item Clone of current object.
     * @throws PropelException
     */
    ...
    public function initHints($overrideExisting = true)
    {
        ...
        $this->collHints->setModel('\Model\Hint');
    }
